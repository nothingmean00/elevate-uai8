...
export default function SuccessStoriesPage() {
  ...
  const filteredStories = useMemo(() => {
    if (selectedCategory === "All") return successStories;
    return successStories.filter(story => story.category === selectedCategory);
  }, [selectedCategory]);
          ...
          >
            <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
              ...
              <div className="hidden md:flex items-center justify-center">
                <div className="flex h-64 w-64 items-center justify-center rounded-full bg-[#5E3CB3]/10">
                  <Sparkles className="h-16 w-16 text-[#5E3CB3]" />
                </div>
              </div>
            </div>
          </motion.div>
