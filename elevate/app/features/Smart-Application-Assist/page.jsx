...
const studyPlanFeatures = [
  ...
  },
  {
    ...
    description: "See quiz results instantly, so you can quickly address areas needing the most improvement."
  },
  {
    label: "Progress Dashboards",
    icon: <BrainCircuit className="h-8 w-8" />,
    description: "Track study time, topic mastery, and grades over time to visualize your progress."
  },
  {
    label: "Motivational Checkpoints",
    icon: <Sparkles className="h-8 w-8" />,
    description: "Set weekly goals, earn achievements, and stay inspired with small wins to keep you on track."
  },
  {
  ...
  return (
    <>
      <Head>
        ...
        />
        <meta name="twitter:image" content="/og-personalized-study-plans.jpg" />
          ...
          <div className="grid items-center gap-8 md:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-[600px] text-muted-foreground md:text-xl">
                ...
                practice materials, and time management strategies—right when you need them.
              </p>
      ...
      <main>
          ...
          <div className="container">
            <div className="mx-auto mb-12 text-center max-w-2xl">
              ...
              <p className="text-muted-foreground md:text-lg">
                Traditional study methods rarely account for your unique learning style 
                or schedule. Our AI tailors recommendations to your real-world constraints 
                and academic goals—ensuring a plan that evolves as you do.
              </p>
            </div>
            <div className="grid gap-8 md:grid-cols-2">
              ...
              >
                ...
                <p className="text-muted-foreground">
                  From adjusting question difficulty to matching you with the ideal 
                  learning format, our system ensures every study session counts. 
                  Say goodbye to generic, one-size-fits-all plans.
                </p>
              </motion.div>
              <motion.div
                className="space-y-4"
              ...
              >
                ...
                <p className="text-muted-foreground">
                  Life happens. Whether you pick up extra shifts at work or 
                  enroll in a new course mid-semester, our AI rebalances your 
                  schedule to keep your academic goals on track.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24 bg-muted">
          <div className="container">
            <div className="mx-auto mb-12 text-center max-w-2xl">
              ...
              <p className="text-muted-foreground md:text-lg">
                Harness the power of AI to study according to your goals, strengths, 
                and available time.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container">
            ...
            >
              ...
              <p className="text-muted-foreground md:text-lg">
                Start with a quick assessment, then let our AI guide your academic 
                journey from one week to the next.
              </p>
            </motion.div>
            <div className="grid gap-12 md:grid-cols-4 md:gap-16">
              ...
              >
                ...
                <p className="text-muted-foreground max-w-xs mx-auto">
                  Complete a short questionnaire detailing your learning style, academic needs, and schedule.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground max-w-xs mx-auto">
                  Get a detailed, week-by-week strategy featuring recommended materials and practice exercises.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground max-w-xs mx-auto">
                  After each session, our AI reviews your performance and adjusts future lessons accordingly.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground max-w-xs mx-auto">
                  Update your plan any time. As your goals or schedule change, 
                  your study roadmap adapts to keep you on course.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24 bg-muted">
          <div className="container">
            ...
            <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto md:text-lg">
              Discover how students like you transformed their academic approach 
              and performance with ElevateU.
            </p>
          ...
          <div className="container">
            ...
            >
              ...
              <p className="mx-auto mt-4 text-muted-foreground md:text-lg">
                Curious about how our AI-driven study plans can help you excel? Read on for answers.
              </p>
            </motion.div>
        ...
        <section className="container py-16 md:py-24 text-center">
          ...
          <p className="text-muted-foreground md:text-lg mb-12 max-w-3xl mx-auto">
            Begin your journey with a study plan that adapts to your evolving needs—boosting
